...
class Constants {
    ...
    companion object {
        const val utterID_1 = "123"

        const val ttsText1 = "David Warner set up the innings with a chance-filled 94 and Travis Head took over with an unbeaten century after a mini-collapse " +
                "in the middle order to guide Australia to 343-7 at stumps on Day 2, a 196-run lead in the Ashes series opener.\n" +
                "\n" +
        ...
        const val ttsText = "<p>Kathak in Kerala? You heard it right." +
                ...
                "Odissi dance and choreography. She is planning a theatre workshop too. </p><p>Rajib Ghosh&#44; however&#44; " +
                "does not have his own space in Thrissur. He uses rented spaces like the Thekke Madom. After he " +
                "found a number of interested students who asked him to continue his classes&#44; Rajib decided to open a " +
                "branch of his institution&#44; Kathak Kala Kendra. His students appear for the Kathak Diploma and P G Diploma courses " +
                "conducted by Chandigarh-based Pracheen Kala Kendra. </p><p>“Now there are 20 students&#44; including those who appear for " +
                "PG Diploma and Diploma&#44;” he says." +
                " Ghosh is planning to open classes in Ottappalam and Kozhikode as well. " +
                "</p><p>He agrees that though Malayalis are too exposed to the dances of North India&#44; " +
                "they do have a knowledge of Hindustani music. “During a performance in Palakkad&#44; " +
                "I’d noted that many from the audience kept the rhythm of the taal I was performing.” " +
                "</p><p>Mayoora Sangeetha Nritha Vidyalaya&#44; another Thrissur-based dance school&#44; " +
                "has announced Kathak classes conducted by Divya Ghogale&#44;affiliated to the Degree and Diploma " +
                "courses offered by Pracheen Kala Kendra. </p><p>Though Kathak is not officially part of the youth " +
